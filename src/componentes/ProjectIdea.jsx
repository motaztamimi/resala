...
// When the user clicks on the button, scroll to the top of the document
  ...
  return (
    <div className='projectIdeaMainSec'>
      <nav className="linkednames"><ul>
        <li><a href="#mmm"> معالم الخطة الرئيسة </a></li>
        <li><a href="#sectionone"> قسم الدراسة </a></li>
        <li><a href="#secondsection"> قسم التحقيق </a></li>
        </ul></nav>
        
      <div className='ideaText'>
        <h1 className='Openning' id="top">بسم الله الرحمن الرحيم</h1>
        <h2 className='Openning2' id="mm">فكرة المشروع</h2>
        ...
        <p className="Sectiontext">الفصل الأول : التعريف بصاحب المتن المرغيناني وبالشارح ابن الهمام وفيه المباحث الآتية : </p>
        <p className="Sectiontext">الأول : نبذة موجزة عن الإمام أبي بكر المرغيناني صاحب الهداية تشمل : حياته العلمية ومكانته في المذهب الحنفي … الخ .</p>
        <p className="Sectiontext" >الثاني : التعريف بعصر الشارح ابن الهمام من حيث :</p>
        <ul>
        ...
        <ul>
          ...
          <li className="Sectiontext Liprop"> مكانته العلمية أصولياً وفقهياً ومحدثاً .</li>
        </ul>
        <p  className="Sectiontext">الفصل الثاني : التعريف بالكتاب فتح القدير وفيه : </p>
        <ul>
          <li className="Sectiontext Liprop">تحقيق اسم الكتاب </li>
          <li className="Sectiontext Liprop">. تحقيق نسبته إلى الشارح ابن الهمام. </li>
          <li className="Sectiontext Liprop">مصادره التي اعتمد عليها . </li>
          <li className="Sectiontext Liprop">ميزات الكتاب . </li>
          <li className="Sectiontext Liprop">بيان اختيارات المؤلف والتعليق عليها . </li>
        </ul>
        <p className="Sectiontext" id="secondsection">القسم الثاني : قسم التحقيق ويشتمل على :</p>
        <ul>
        ...
        <ul>
          <li className="Sectiontext Liprop">ضبط نص الكتاب بحيث يكون أقرب إلى الصورة التي وضعه مؤلفه عليها . </li>
          <li className="Sectiontext Liprop">اتباع الرسم الإملائي الحديث . </li>
          <li className="Sectiontext Liprop">مقابلة النسخ ووضع الفروق التي يبنى علها اختلاف في الهامش . </li>
          <li className="Sectiontext Liprop">ترقيم الآيات القرآنية ببيان اسم السورة ورقم الآية .</li>
          <li className="Sectiontext Liprop">تخريج الأحاديث النبوية فإذا كان الحديث في الصحيحين أو في أحدهما فيكتفى بذلك مع التوثيق منهما أو من أحدهما، وأما إذا كان الحديث في غيرهما من مصادر السنة فيخرج من مصادره ويذكر حكم أهل الحديث عليه. </li>
          <li className="Sectiontext Liprop">عزو الأبيات الشعرية إلى قائليها وتوثيق ذلك من مصادرها . </li>
          <li className="Sectiontext Liprop">الترجمة للأعلام الذين ذكرهم الشارح في الكتاب ترجمة موجزة وتوثيق ذلك من كتب التراجم . </li>
          <li className="Sectiontext Liprop">توثيق ما يرد في الكتاب من النقول والآراء والأقوال من المصادر المعتمدة . </li>
          <li className="Sectiontext Liprop">شرح الألفاظ الغريبة .</li>
          <li className="Sectiontext Liprop">توثيق المسائل الفقهية من المصادر المعتمدة عند المذاهب الفقهية. </li>
          <li className="Sectiontext Liprop">عمل الفهارس الآتية : 
          <ul>
            <li className="Sectiontext Liprop1"> 	فهرس الآيات القرآنية . </li>
            <li className="Sectiontext Liprop1"> 	فهرس الأحاديث النبوية .  </li>
            <li className="Sectiontext Liprop1"> 	فهرس الحدود والمصطلحات والألفاظ الغريبة</li>
            ...
            <li className="Sectiontext Liprop1">	فهرس الكتب الواردة في النص  </li>
        ...
        <p className="Sectiontext">وختاماً فإني آمل إن تمَّ هذا العمل العلمي - بهذه الخطة التي يجب أن يلتزم بها جميع الباحثين المشاركين فيه - أن نكون قد قدمنا خدمة جليلة للفقه الإسلامي عامة وللفقه الحنفي خاصة .</p>
